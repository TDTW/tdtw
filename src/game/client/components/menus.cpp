...
int CMenus::DoButton_CheckBox_Number(const void *pID, const void *s_CheckBox, const char *pText, int Checked, const CUIRect *pRect)
{
	char aBuf[16];
...
int CMenus::DoCoolScrollbarH(const void *pID, const float *pFade, const CUIRect *pRect, int Real, float Min, float Max, int ShowNumber)
{
	CUIRect Handle;
